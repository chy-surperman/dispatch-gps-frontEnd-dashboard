            ...
            <el-table size="mini" :data="importRecords" border highlight-current-row style="width: 100%;margin-top:20px;">
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini"  v-if="scope.row.importStatus == 1 || scope.row.importStatus == 5" 
                            @click="_confirmImport(scope.row.templateId,scope.row.batchNo)">确认导入</el-button>
                        <el-button size="mini"  v-if="scope.row.importStatus == 4 ||scope.row.importStatus == 1 || scope.row.importStatus == 3" 
