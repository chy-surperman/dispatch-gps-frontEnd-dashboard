  ...
  <div class="schedule-wrap">
    <el-row class="schedule-panel">
      ...
      <el-table max-height="500" v-loading="loading" size="small" :data="dataTables" align="center" highlight-current-row style="width: 100%">
        ...
        <el-table-column align="center" prop="alarmDateStr" label="日期" width="200"></el-table-column>
        <el-table-column align="center" prop="deviceName" label="车牌号" width="120"></el-table-column>
        <el-table-column align="center" prop="alarmTypeName" label="报警类型" width="150"></el-table-column>
        <el-table-column align="center" prop="orgName" label="线路" width="120"></el-table-column>
        <el-table-column align="center" prop="speed" label="速度" width="80"></el-table-column>
        <el-table-column align="center" prop="gpsY" label="纬度" width="150"></el-table-column>
        <el-table-column align="center" prop="gpsX" label="经度" width="150"></el-table-column>
        <el-table-column align="center" prop="alarmPicture" label="报警图片" width="800"></el-table-column>
      </el-table>
...
import {queryAdasDetail} from '@/api/statistics'
